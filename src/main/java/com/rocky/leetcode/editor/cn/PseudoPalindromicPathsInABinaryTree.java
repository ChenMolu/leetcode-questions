...
// 
//
// Related Topics 位运算 树 深度优先搜索 广度优先搜索 二叉树 👍 77 👎 0
...
public class PseudoPalindromicPathsInABinaryTree {
    public static void main(String[] args) {
        ...
        TreeNode treeNode = TreeNode.constructBinaryTree(new int[]{2,3,1,3,1,-1,1});
    ...
    class Solution {
        ...
        public void backTracing(TreeNode cur) {
